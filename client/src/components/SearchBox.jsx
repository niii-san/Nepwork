...
const SearchBox = ({ type, className }) => {
    ...
    return (
        <div
            className={`bg-primary rounded-xl px-4 py-8 relative ${className}`}
        >
            {/* Main Search Area */}
            <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
                    Work from anywhere, hire for{" "}
                    <br className="hidden md:inline" /> anything!
                </h1>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="relative pt-4">
                                        <div className="h-1 bg-gray-200 rounded-full">
                                            <div className="absolute h-1 bg-primary w-4/5 rounded-full" />
                                        </div>
                                    </div>
                                </div>
                            </div>
