...
function Footer() {
    ...
    return (
        <>
            <footer
                className={`w-full bg-primary mt-auto border-t-2 border-secondary ${location.pathname === "/inbox" ? "hidden" : "block"}`}
            >
                <div
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-sm opacity-90">
                                Connecting Nepali Talent with Global
                                Opportunities
                            </p>
